         ...
         <div class="carousel-inner">
           ...
           <div class="carousel-item active">
             <div class="page-content page-container" id="page-content">
               <div id="karosel">
                 <div class="photo" style="background-image:url('/image/puji.jpeg');
                 ...
                 <div class="datasiswa">
                   ...
                   <hr>
                   <p class="nama">Sri Puji Lestari</p>
                   <p class="nilai"><strong></strong></p>
                <p class="h-judul">Quotes</p>
                <p class="isi-judul">"Seseorang hanya belajar dengan dua cara, satu dengan membaca, dan yang lainnya dengan bergaul dengan orang yang lebih pintar." - Will Rogers</p>
                <p class="h-pemb"></p>
                <p class="isi-pemb"></p>
              </div>
            </div>
