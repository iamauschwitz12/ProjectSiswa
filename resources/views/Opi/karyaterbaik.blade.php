        ...
        <div class="carousel-item active">
          <div class="page-content page-container" id="page-content">
            <div id="karosel">
                ...
                margin-top: 10px;
                ">
                  <source src="/image/nominasi1.mp4" type="video/mp4">
          ...
          <div class="carousel-item">
            <div class="page-content page-container" id="page-content">
                        <div id="karosel">
                          <div class="photo" style="background-image:url('/image/20211214060223.jpg');
                          width:300px; height:460px; background-position: center; background-size: cover;">
                          </div>
                          <div class="datasiswa">
                            <p class="prof">Project Terbaik</p>
                            <p class="angkatan">Angkatan 21</p>
                            <hr>
                            <p class="nama">Muhammad Rafi Akbar</p>
                            <p class="nilai">Nilai Akhir : <strong>	87,31</strong></p>
                            <p class="h-judul">Judul Tugas Akhir</p>
                            <p class="isi-judul">Desain Website Blog Pribadi "Lekturloka.com" Menggunakan HTML, CSS, Bootstrap dan PHP di Visual Code Studio.</p>
                            <p class="h-pemb">Pembimbing</p>
                            <p class="isi-pemb">Muhammad Ilham S.Kom</p>
                          </div>
                        </div>
                      </div>
        </div>
