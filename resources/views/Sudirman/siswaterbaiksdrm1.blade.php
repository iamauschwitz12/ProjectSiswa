...
transition: all 0.3s ease-in-out
  ...
  <body>
    ...
    <div id="karosel">
      <div class="photo" style="background-image:url('/image/20211206232219.jpg');
      ...
      <div class="datasiswa">
        ...
        <hr>
        <p class="nama">Rahma Tiana</p>
        <p class="nilai">Nilai Akhir : <strong>82,66</strong></p>
        <p class="h-judul">Judul Tugas Akhir</p>
        <p class="isi-judul">Web Jasa Endorsement Dezainla Creative Group menggunakan Framework Laravel</p>
