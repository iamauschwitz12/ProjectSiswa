...
transition: all 0.3s ease-in-out
  ...
  <body>
    ...
    <div id="karosel">
      <div class="photo" style="background-image:url('/image/20211213093126.jpg');
      ...
      <div class="datasiswa">
        ...
        <hr>
        <p class="nama">Anggara Sodikin</p>
        <p class="nilai">Nilai Akhir : <strong>81,48</strong></p>
        <p class="h-judul">Judul Tugas Akhir</p>
        <p class="isi-judul">Instalasi Mikrotik untuk Manajemen Jaringan di PT. Astra Graphia. Tbk</p>
