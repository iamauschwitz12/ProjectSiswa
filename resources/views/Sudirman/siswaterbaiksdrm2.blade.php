...
transition: all 0.3s ease-in-out
  ...
  <body>
    ...
    <div id="karosel">
      <div class="photo" style="background-image:url('/image/20211213104947.jpg');
      width:300px; height:460px; background-position: center; background-size: cover;">
      </div>
      <div class="datasiswa">
        <p class="prof">Terbaik Profesional 1 Tahun</p>
        <p class="angkatan">Angkatan 76</p>
        <hr>
        <p class="nama">Ranita Anggraini</p>
        <p class="nilai">Nilai Akhir : <strong>81,57</strong></p>
        <p class="h-judul">Judul Tugas Akhir</p>
        <p class="isi-judul">Website Owner Profile Dezainla Creative Group menggunakan HTML 5 dan CSS 3</p>
        <p class="h-pemb">Pembimbing</p>
        <p class="isi-pemb">Afifah Fasywah, A.Md</p>
      </div>
    </div>
    </div>
  </div>
...
<div class="tombol">
  <a href="/terbaiksudirman">
    <button type="button" class="btn btn-primary"
      style="
      font-weight: bold;
      background-color: #ff7800;
      ">
    Daftar Terbaik</button>
  </a>
</div>
<div class="tombol">
