    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="100000" style="margin-top:10px;">
        ...
        <div class="carousel-item active">
          <div class="page-content page-container" id="page-content">
            <div id="karosel">
              <div class="photo" style="background-image:url('/image/afifah.jpeg');
              width:300px; height:460px; background-position: center; background-size: cover;">
              </div>
              <div class="datasiswa">
                <p class="prof">Congralutation</p>
                <p class="angkatan">Instruktur Terfavorit Tahun 2021</p>
                <hr>
                <p class="nama">Afifah Fasywah, A.Md</p>
                <p class="nilai"><strong></strong></p>
                <p class="h-judul">Instruktur</p>
                <p class="isi-judul">Ms. office, teknisi, desain web, web programming</p>
                <p class="h-pemb"></p>
                <p class="isi-pemb"></p>
              </div>
            </div>
