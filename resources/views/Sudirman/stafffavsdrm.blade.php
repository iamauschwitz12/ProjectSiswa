         ...
         <div class="carousel-inner">
           ...
           <div class="carousel-item active">
             <div class="page-content page-container" id="page-content">
               <div id="karosel">
                 <div class="photo" style="background-image:url('/image/yurine.jpeg');
                 width:300px; height:460px; background-position: center; background-size: cover;">
                 </div>
                 <div class="datasiswa">
                   <p class="prof">Congralutation</p>
                   <p class="angkatan">Staff Terfavorit Tahun 2021</p>
                   <hr>
                   <p class="nama">Yurine Hanna, S.Kom</p>
                   <p class="nilai"> finance palcomtech palembang<strong></strong></p>
                <p class="h-judul">Quotes</p>
                <p class="isi-judul">"Tidak ada di dunia ini yang diberikan kepadamu. Kamu harus keluar dan mendapatkannya! Tidak ada yang mengatakan itu akan mudah, tetapi kerja keras selalu terbayar."</p>
                <p class="h-pemb"></p>
                <p class="isi-pemb"></p>
              </div>
            </div>
